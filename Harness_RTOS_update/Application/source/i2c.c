...
{
    /* enable GPIOB clock */
    rcu_periph_clock_enable(RCU_GPIO_I2C_TX);
    rcu_periph_clock_enable(RCU_GPIO_I2C_RX);
    ...
    if(RESET == i2c_process_flag) {
        ...
        case I2C_SEND_ADDRESS_FIRST:
            if(i2c_interrupt_flag_get(I2CX, I2C_INT_FLAG_SBSEND)) {
                /* send slave address */
                i2c_master_addressing(I2CX, I2CX_SLAVE_ADDRESS7<<1, I2C_TRANSMITTER);
        ...
        case I2C_SEND_ADDRESS_SECOND:
            if(i2c_interrupt_flag_get(I2CX, I2C_INT_FLAG_SBSEND)) {
                i2c_master_addressing(I2CX, I2CX_SLAVE_ADDRESS7<<1, I2C_RECEIVER);
                if(i2c_nbytes < 3) {
                    /* disable acknowledge */
