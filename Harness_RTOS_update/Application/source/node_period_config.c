...
{
    uint8_t slotLLineVolum = stBroadcastFrame.synchData.synchSlot[g_i16PeriodOrder].L_LineVolum;
    uint8_t slotZLineVolum = stBroadcastFrame.synchData.synchSlot[g_i16PeriodOrder].Z_LineVolum;
