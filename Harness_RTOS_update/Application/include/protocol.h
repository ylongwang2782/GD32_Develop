...
extern int16_t g_i16PinNumBefore; /* The sum of the pins that before this slot. */
extern uint8_t g_u8NodeHexDataBuffer[];/* Hex data buffer during the node time */
extern uint8_t g_u8SlotBinDataBuffer[]; /* The binary data buffer during the stSlot time */
extern uint8_t g_u8NodeBinDataBuffer[];    /* The binary data buffer during the node time */

extern int16_t g_i16PinNumBeforeZ; /* The sum of the pins that before this slot. */
extern uint16_t g_u16SlotAdcDataBuffer[]; /* The binary data buffer during the stSlot time */
extern uint8_t g_u8SlotResDataBuffer[]; /* The binary data buffer during the stSlot time */
extern uint8_t g_u8NodeAdcDataBuffer[];    /* The binary data buffer during the node time */


extern uint8_t g_u8ReceivedByte;
...
extern uint8_t g_u8ReceiveBytePosition; /* The pointer g_u8ReceiveBytePosition for the receiving byte array check */
extern uint8_t g_u8ReceiveByteHeaderPosition;  /* The pointer of the header g_u8ReceiveBytePosition for the header frame check */
extern uint8_t g_u8DataReceiveBuffer[];  /* The data receive buffer for the data received from the usart */
extern uint8_t g_u8FrameHeader[]; /* Array of the frame header for header check */
